...
class AgentSubAgentSummaryTest {
    ...
    fun parsesTheThreeSections() {
        val summary = AgentSubAgentSummary.parse(
            ...
            证据：app/src/main/kotlin/io/github/mangi/eta/data/world/WorldKnowledgeStore.kt:42
        ...
        assertEquals(
            listOf("app/src/main/kotlin/io/github/mangi/eta/data/world/WorldKnowledgeStore.kt"),
            summary.filePaths,
        )
