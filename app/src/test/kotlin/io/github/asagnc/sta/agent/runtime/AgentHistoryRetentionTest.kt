...
import io.github.asagnc.sta.ui.app.AgentConversationStore
import io.github.asagnc.sta.ui.model.AgentChatUiState
...
class AgentHistoryRetentionTest {
    ...
    private val config = AgentModelClient.ModelConfig(
        ...
        reasoningEffort = io.github.asagnc.sta.data.model.ReasoningEffort.OFF,
    )
    ...
    @Test fun fullHistoryAndLargeMessageSurviveDatabaseReopen() {
        ...
        val db = StaDatabase.get(context).openHelper.readableDatabase
        ...
        StaDatabase.get(context).openHelper.readableDatabase.query("SELECT COUNT(*) FROM agent_text_chunks").use {
    ...
    @Test fun missingChunkFailsInsteadOfReturningEmptyHistory() {
        ...
        StaDatabase.get(context).openHelper.writableDatabase.execSQL("DELETE FROM agent_text_chunks WHERE chunk_index = 1")
