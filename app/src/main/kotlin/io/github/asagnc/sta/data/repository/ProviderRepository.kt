...
import io.github.asagnc.sta.data.db.toDomain
import io.github.asagnc.sta.data.db.toEntity
import io.github.asagnc.sta.data.db.toModelEntities
...
import io.github.asagnc.sta.data.model.Settings
import io.github.asagnc.sta.data.model.selectedOrFirstModel
import io.github.asagnc.sta.data.model.withApiKey
import io.github.asagnc.sta.data.model.withModels
import io.github.asagnc.sta.data.model.withSortOrder
import io.github.asagnc.sta.data.provider.BuiltinProviders
import io.github.asagnc.sta.data.provider.OfficialModelCatalog
...
internal object ProviderRepository {
    ...
    private fun dao() =
        StaDatabase.get(appContext()).providerDao()
