...
/**
 * Sta App 与 system_server 无障碍保护后端之间的最小协议。
 *
...
internal object AccessibilityProtectionProtocol {
    ...
    const val ACTION_SET =
        "io.github.asagnc.sta.action.SET_ACCESSIBILITY_PROTECTION"
    const val ACTION_RECOVER =
        "io.github.asagnc.sta.action.RECOVER_ACCESSIBILITY_SERVICE"
    const val PERMISSION =
        "io.github.asagnc.sta.permission.CONTROL_ACCESSIBILITY_PROTECTION"
