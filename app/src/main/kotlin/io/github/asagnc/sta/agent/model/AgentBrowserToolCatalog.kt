                    ...
                    .put(
                        ...
                        JSONObject()
                            ...
                            .put(
                                ...
                                JSONObject()
                                    .put("type", "string")
                                    .put("description", "download 保存的文件名，省略时按 Content-Disposition 或 URL 末段命名，落盘目录固定为 Download/Sta。")
                            )
                            .put(
                                "proxy",
                                JSONObject()
