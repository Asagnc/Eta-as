package io.github.asagnc.sta.hook.breeno
...
import io.github.asagnc.sta.core.HookRegistrar
...
import io.github.asagnc.sta.hook.StaInjectedStrings
...
internal object BreenoHooks {
    ...
    ): String = StaInjectedStrings.get(context, resourceId, englishFallback, *formatArgs)
    ...
    private val modelExecutor = ThreadPoolExecutor(
        ...
        { runnable ->
            Thread(
                runnable,
                "Sta-AgentBridge-${agentBridgeThreadId.incrementAndGet()}"
            ).apply { isDaemon = true }
        },
                ...
                val modelResponse = runCatching {
                    ...
                    if (!Prefs.isEnabled(Prefs.Keys.AGENT_CUSTOM_MODEL)) {
                        error(injected(
                            ...
                            "Enable Breeno custom models in Sta settings first",
                        ))
                    }
