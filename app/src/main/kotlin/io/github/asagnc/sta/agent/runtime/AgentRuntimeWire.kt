...
internal object AgentRuntimeWire {
    ...
    const val ACTION_BIND = "io.github.asagnc.sta.agent.runtime.BIND"
    ...
    private const val MODULE_PACKAGE = "io.github.asagnc.sta"
    private const val SERVICE_CLASS = "io.github.asagnc.sta.agent.runtime.AgentRuntimeService"
        ...
        readText: Boolean,
            ...
            config = AgentModelClient.ModelConfig(
                ...
                providerType = bundle.getString(KEY_PROVIDER_TYPE).orEmpty()
                    .ifBlank { io.github.asagnc.sta.data.model.ProviderTypes.OPENAI_COMPATIBLE },
                ...
                anthropicVersion = bundle.getString(KEY_ANTHROPIC_VERSION).orEmpty()
                    .ifBlank { io.github.asagnc.sta.data.model.AnthropicProviderSetting.DEFAULT_ANTHROPIC_VERSION },
                ...
                openAiEndpointMode = bundle.getString(KEY_OPENAI_ENDPOINT_MODE).orEmpty()
                    .ifBlank { io.github.asagnc.sta.data.model.OpenAiEndpointMode.CHAT_COMPLETIONS },
