...
import io.github.asagnc.sta.agent.model.AgentContextSnapshot
...
import io.github.asagnc.sta.agent.device.AgentFileReferenceGateway
import io.github.asagnc.sta.agent.device.DeviceLocationProvider
...
import io.github.asagnc.sta.agent.model.AgentFileReferencePolicy
import io.github.asagnc.sta.agent.model.AgentFileReferencePromptCodec
import io.github.asagnc.sta.agent.model.AgentModelClient
import io.github.asagnc.sta.agent.roleplay.RoleplayBinding
import io.github.asagnc.sta.agent.roleplay.CharacterMacros
import io.github.asagnc.sta.agent.roleplay.CharacterCardCodec
import io.github.asagnc.sta.agent.roleplay.RoleplayMessageLink
import io.github.asagnc.sta.agent.roleplay.RoleplayMessageState
import io.github.asagnc.sta.data.repository.CharacterRepository
import io.github.asagnc.sta.agent.runtime.AgentEvent
import io.github.asagnc.sta.agent.runtime.AgentExecutionService
import io.github.asagnc.sta.agent.runtime.AgentExternalArchivePayload
import io.github.asagnc.sta.agent.runtime.AgentRunArchiveStore
import io.github.asagnc.sta.agent.runtime.AgentRunCheckpointStore
...
import io.github.asagnc.sta.agent.runtime.AgentUiHandoffPayload
import io.github.asagnc.sta.agent.runtime.ConversationRunPurge
...
import io.github.asagnc.sta.data.repository.StaBackupRepository
...
import io.github.asagnc.sta.data.repository.ModelUsageDelta
import io.github.asagnc.sta.data.repository.RuntimeConfigRepository
import io.github.asagnc.sta.ui.model.AgentChatHomeUiState
import io.github.asagnc.sta.ui.model.AgentSubAgentProjector
import io.github.asagnc.sta.ui.model.AgentPlanCodec
import io.github.asagnc.sta.ui.model.AgentPlanStatus
import io.github.asagnc.sta.ui.model.AgentPlanUi
import io.github.asagnc.sta.ui.model.AgentTaskPlanCodec
...
import io.github.asagnc.sta.ui.model.AgentModelPickerProjector
...
import io.github.asagnc.sta.ui.model.ConversationModeUi
...
import io.github.asagnc.sta.ui.model.SkillNoticeUi
import io.github.asagnc.sta.ui.model.SkillReplacementUi
...
import io.github.asagnc.sta.ui.model.ToolGroupUi
...
import io.github.asagnc.sta.ui.model.contentMatches
...
internal class AgentAppState(
     ...
     * Auto 是 Sta 自己的策略，不需要模型声明支持它；没有能力元数据（多数中转站）时
     ...
     * 它由 Sta 自己按用途与轮次解析，不需要模型声明支持哪些档位；其余一律按 Off 处理。
     */
    ...
    suspend fun exportBackup(output: OutputStream): StaBackupSummary =
        StaBackupRepository.export(appContext, output)

    suspend fun importBackup(input: InputStream): StaBackupSummary {
        ...
        val summary = StaBackupRepository.import(appContext, input)
...
private fun buildPermissionHealthState(context: Context): PermissionHealthUiState {
    ...
    val notificationHistoryEnabled = io.github.asagnc.sta.agent.device.AgentNotificationHistoryService.isEnabled(context)
    val usageAccessEnabled = io.github.asagnc.sta.agent.tool.AgentPersonalContextTools.hasUsageAccess(context)
