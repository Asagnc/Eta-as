...
import io.github.asagnc.sta.data.model.runtimeProviderType
...
import io.github.asagnc.sta.data.provider.ReasoningCapabilityResolver
...
internal object RuntimeConfigRepository {
    ...
    fun buildRuntimeConfig(provider: ProviderSetting, model: Model): AgentModelClient.ModelConfig {
        ...
        val inferOpenAiCatalog = sourceType == io.github.asagnc.sta.data.model.ProviderSourceTypes.CUSTOM &&
        ...
        val reasoningCapabilities = ReasoningCapabilityResolver.resolve(
            sourceType = if (inferOpenAiCatalog) {
                io.github.asagnc.sta.data.model.ProviderSourceTypes.OPENAI
            } else {
                sourceType
            },
            model = model,
