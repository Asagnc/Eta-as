...
import io.github.asagnc.sta.agent.device.RootAccessState
import io.github.asagnc.sta.agent.device.RootAccessStatus
...
internal fun rememberDeviceCapabilities(): DeviceCapabilitiesUi {
    ...
    var xposedConnected by remember { mutableStateOf(StaApp.serviceInstance != null) }
    ...
    DisposableEffect(owner, context) {
        ...
        onDispose {
            StaApp.removeServiceStateListener(listener)
