...
import io.github.asagnc.sta.agent.model.AgentContextBudget
...
internal data class RoleplayRunContext(
    ...
    private fun personaPrompt(before: String, after: String): String = buildString {
        appendLine("本会话的角色人格：${card.name}。以该人物的身份和语气交流，不要在普通剧情中自称 Sta。")
    ...
    companion object {
        ...
        suspend fun resolve(
            ...
            val raw = StaDatabase.get(context).conversationDao().roleplayJson(conversationId)
