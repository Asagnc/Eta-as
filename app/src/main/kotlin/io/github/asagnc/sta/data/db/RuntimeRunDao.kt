...
internal interface RuntimeRunDao : ChunkedTextDao {
    ...
    @Query("SELECT run_id, handoff_id, handoff_source, handoff_payload, ok, operation, rewrite_target_message_id, created_at FROM runtime_results ORDER BY created_at ASC LIMIT :limit")
