...
import io.github.asagnc.eta.data.model.CustomBody
...
internal object AgentRuntimeWire {
    ...
    const val ACTION_BIND = "io.github.asagnc.eta.agent.runtime.BIND"
    ...
    private const val MODULE_PACKAGE = "io.github.asagnc.eta"
    private const val SERVICE_CLASS = "io.github.asagnc.eta.agent.runtime.AgentRuntimeService"
    ...
    private const val KEY_CONTEXT_EDITING_ENABLED = "context_editing_enabled"
    ...
    private fun requestBundle(request: RunRequest, imageBundles: List<Bundle>, payloadDirectory: File? = null): Bundle = Bundle().apply {
        ...
        putBoolean(KEY_CONTEXT_EDITING_ENABLED, request.config.contextEditingEnabled)
        ...
        readText: Boolean,
            ...
            config = AgentModelClient.ModelConfig(
                ...
                providerType = bundle.getString(KEY_PROVIDER_TYPE).orEmpty()
                    .ifBlank { io.github.asagnc.eta.data.model.ProviderTypes.OPENAI_COMPATIBLE },
                ...
                anthropicVersion = bundle.getString(KEY_ANTHROPIC_VERSION).orEmpty()
                    .ifBlank { io.github.asagnc.eta.data.model.AnthropicProviderSetting.DEFAULT_ANTHROPIC_VERSION },
                promptCacheEnabled = bundle.getBoolean(KEY_PROMPT_CACHE_ENABLED, false),
                contextEditingEnabled = bundle.getBoolean(KEY_CONTEXT_EDITING_ENABLED, false),
                openAiEndpointMode = bundle.getString(KEY_OPENAI_ENDPOINT_MODE).orEmpty()
                    .ifBlank { io.github.asagnc.eta.data.model.OpenAiEndpointMode.CHAT_COMPLETIONS },
