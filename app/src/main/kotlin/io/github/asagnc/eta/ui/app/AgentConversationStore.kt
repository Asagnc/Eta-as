...
import io.github.asagnc.eta.data.db.ConversationContextCheckpointEntity
import io.github.asagnc.eta.data.db.ConversationEntity
import io.github.asagnc.eta.data.db.ConversationMetadata
import io.github.asagnc.eta.data.db.ConversationMessageEntity
import io.github.asagnc.eta.data.db.ConversationStateEntity
...
import io.github.asagnc.eta.ui.model.ToolActivityStatusUi
            ...
            withContext(Dispatchers.IO) {
                ...
                val conversations = sorted.map { (id, state) ->
                    ConversationEntity(
                        ...
                        planJson = AgentPlanCodec.encode(state.plan),
    ...
    private suspend fun loadSnapshot(context: Context): Snapshot {
        ...
        conversations.forEach { conversation ->
            ...
            states[conversation.id] = AgentChatHomeUiState(
                ...
                plan = AgentPlanCodec.decode(conversation.planJson),
