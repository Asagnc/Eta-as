...
import io.github.asagnc.eta.data.model.runtimeProviderType
...
import io.github.asagnc.eta.data.provider.ReasoningCapabilityResolver
...
internal object RuntimeConfigRepository {
    ...
    fun buildRuntimeConfig(provider: ProviderSetting, model: Model): AgentModelClient.ModelConfig {
        ...
        val inferOpenAiCatalog = sourceType == io.github.asagnc.eta.data.model.ProviderSourceTypes.CUSTOM &&
        ...
        val reasoningCapabilities = ReasoningCapabilityResolver.resolve(
            sourceType = if (inferOpenAiCatalog) {
                io.github.asagnc.eta.data.model.ProviderSourceTypes.OPENAI
            } else {
                sourceType
            },
            model = model,
