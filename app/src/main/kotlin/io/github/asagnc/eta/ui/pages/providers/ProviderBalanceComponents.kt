...
import io.github.asagnc.eta.data.model.BalanceOption
import io.github.asagnc.eta.data.model.ProviderSetting
import io.github.asagnc.eta.data.repository.ProviderBalanceFetcher
import io.github.asagnc.eta.data.repository.formatBalanceDisplay
import io.github.asagnc.eta.ui.icons.MoneyBag02
                ...
                Column(modifier = Modifier.padding(start = 16.dp, end = 16.dp, bottom = 16.dp)) {
                    if (isNewApi) {
                        ...
                        TextField(
                            ...
                            onValueChange = {
                                onBalanceOptionChange(balanceOption.copy(apiPath = it))
                            },
                        ...
                        TextField(
                            ...
                            onValueChange = {
                                onBalanceOptionChange(balanceOption.copy(resultPath = it))
                            },
                        ...
                        Text(
                            text = stringResource(R.string.ui_balance_result_path_summary),
                            style = MiuixTheme.textStyles.footnote2,
                            color = MiuixTheme.colorScheme.onSurfaceVariantSummary,
                    ...
                    TextButton(
                        ...
                        enabled = balanceOption.enabled && !isTesting && provider != null,
                        modifier = Modifier.fillMaxWidth(),
                        onClick = {
