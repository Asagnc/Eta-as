...
internal object AccessibilityProtectionProtocol {
    ...
    const val ACTION_SET =
        "io.github.asagnc.eta.action.SET_ACCESSIBILITY_PROTECTION"
    const val ACTION_RECOVER =
        "io.github.asagnc.eta.action.RECOVER_ACCESSIBILITY_SERVICE"
    const val PERMISSION =
        "io.github.asagnc.eta.permission.CONTROL_ACCESSIBILITY_PROTECTION"
    ...
    const val HEALTH_AUTHORITY = "io.github.asagnc.eta.accessibility.health"
